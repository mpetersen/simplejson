...
class SimpleJsonTest {
  ...
  private Map<String, Object> assertMap(
      String jsonInput, int expectedEntries, Object... expectedData) {
    ...
    Map<String, Object> actual = (Map<String, Object>) simpleJson.readValue(jsonInput);
  ...
  private void assertList(String jsonInput, Object... expectedData) {
    List<Object> expected = Arrays.asList(expectedData);
    Object actual = simpleJson.readValue(jsonInput);

    assertEquals(expected, actual);
  }

  private void assertIllegalStateException(Executable executable) {
    assertException(IllegalStateException.class, executable);
  }

  private <T extends Throwable> void assertException(
      Class<T> exceptionClass, Executable executable) {
